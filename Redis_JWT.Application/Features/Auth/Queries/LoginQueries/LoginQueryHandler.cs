...
{
    public class LoginQueryHandler(IRedisJwtContext db, IPasswordHasher hasher, IJwtTokenGenerator jwt) : IRequestHandler<LoginQuery, Result<LoginResultDto>>
    {
        private readonly IRedisJwtContext _db = db;
